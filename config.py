...
front_left_encoder_zeroed_pos: float = 1.5171039327979088 / (2*math.pi)
...
front_right_encoder_zeroed_pos: float = 1.7456666082143784 / (2*math.pi)
...
back_left_encoder_zeroed_pos: float = -2.7626938149333 / (2*math.pi)
...
back_right_encoder_zeroed_pos: float = -2.305568464100361 / (2*math.pi)
